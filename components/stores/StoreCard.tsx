    ...
    return (
        <div
            ...
            <div className="relative h-32 w-full mb-3 rounded-lg overflow-hidden">
                <Image
                    src={(store.gallery as Gallery)?.coverImageUrl}
                    alt={store?.shopName}
                    fill
            ...
            <div className="flex justify-between items-start mb-2">
                <div>
                    <h3 className="font-semibold text-gray-800">{store?.shopName}</h3>
          ...
          {store?.status}
            ...
            <p className="text-sm text-gray-600 mb-3">
                {(store?.shopAddress as Address)?.street}, {(store?.shopAddress as Address)?.city}
            </p>
            ...
            <div className="flex items-center gap-2">
                ...
                <div>
                    <p className="text-sm font-medium text-gray-800">{store?.ownerName}</p>
    ...
    return (
        <div className="flex cursor-pointer items-center gap-4 bg-white p-3 hover:bg-gray-100 transition">
            ...
            <div className="flex-1 min-w-0">
                <p className="font-semibold truncate text-sm">{store?.shopName}</p>
                <p className="text-xs text-gray-500 capitalize">{store?.category}</p>
            </div>

            <div className="text-right">
                <p className="text-sm font-medium text-gray-800">{(store?.ownerAddress as Address)?.city}</p>
