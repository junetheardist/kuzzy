  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Input label="Postal Code *" {...register('address.postalCode', { required: 'Postal code is required' })} />
        <Input label="Latitude" type="number" step="any" {...register('address.latitude', { valueAsNumber: true })} />
        <Input label="Longitude" type="number" step="any" {...register('address.longitude', { valueAsNumber: true })} />
      </div>
